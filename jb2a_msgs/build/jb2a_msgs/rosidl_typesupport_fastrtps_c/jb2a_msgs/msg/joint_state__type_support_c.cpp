...
#include "jb2a_msgs/msg/joint_state__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_generator_c/primitives_sequence.h"  // joint
#include "rosidl_generator_c/primitives_sequence_functions.h"  // joint

// forward declare type support functions


using _JointState__ros_msg_type = jb2a_msgs__msg__JointState;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: joint
  {
    ...
    if (ros_message->joint.data) {
      rosidl_generator_c__uint16__Sequence__fini(&ros_message->joint);
    }
    if (!rosidl_generator_c__uint16__Sequence__init(&ros_message->joint, size)) {
      return "failed to create array for field 'joint'";
    }
    auto array_ptr = ros_message->joint.data;
...
size_t get_serialized_size_jb2a_msgs__msg__JointState(
  const void * untyped_ros_message,
...
static uint32_t _JointState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_jb2a_msgs__msg__JointState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_jb2a_msgs
size_t max_serialized_size_jb2a_msgs__msg__JointState(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_jb2a_msgs__msg__JointState(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, jb2a_msgs, msg, JointState)() {
