...
bool jb2a_msgs__msg__joint_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "jb2a_msgs.msg._joint_state.JointState",
        full_classname_dest, 37) == 0);
  }
  jb2a_msgs__msg__JointState * ros_message = _ros_message;
  {  // joint
    ...
    uint16_t * dest = ros_message->joint.data;
...
PyObject * jb2a_msgs__msg__joint_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("jb2a_msgs.msg._joint_state");
  ...
  {  // joint
    ...
    if (ros_message->joint.size > 0) {
      ...
      uint16_t * src = &(ros_message->joint.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->joint.size * sizeof(uint16_t));
      assert(data != NULL);
