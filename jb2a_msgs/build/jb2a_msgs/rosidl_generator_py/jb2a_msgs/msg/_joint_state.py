...
class JointState(metaclass=Metaclass_JointState):
    ...
    _fields_and_field_types = {
        'joint': 'sequence<uint16, 5>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.BasicType('uint16'), 5),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        self.joint = array.array('H', kwargs.get('joint', []))
    ...
    def joint(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'H', \
                "The 'joint' array.array() must have the type code of 'H'"
            assert len(value) <= 5, \
                "The 'joint' array.array() must have a size <= 5"
            self._joint = value
            return
        if __debug__:
            ...
            assert \
                ...
                "The 'joint' field must be a set or sequence with length <= 5 and each value of type 'int' and each unsigned integer in [0, 65535]"
        self._joint = array.array('H', value)
